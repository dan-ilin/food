...
INSERT INTO "nutrient" (
  ...
  (257, 'g', null, 'Adjusted Protein', '2', 700),
  ...
  (313, 'mcg', 'FLD', 'Fluoride, F', '1', 6240),
  (315, 'mg', 'MN', 'Manganese, Mn', '3', 6100),
  (317, 'mcg', 'SE', 'Selenium, Se', '1', 6200),
  (318, 'IU', 'VITA_IU', 'Vitamin A, IU', '0', 7500),
  (319, 'mcg', 'RETOL', 'Retinol', '0', 7430),
  (320, 'mcg', 'VITA_RAE', 'Vitamin A, RAE', '0', 7420),
  (321, 'mcg', 'CARTB', 'Carotene, beta', '0', 7440),
  (322, 'mcg', 'CARTA', 'Carotene, alpha', '0', 7450),
  (323, 'mg', 'TOCPHA', 'Vitamin E (alpha-tocopherol)', '2', 7900),
  (324, 'IU', 'VITD', 'Vitamin D', '0', 8750),
  (325, 'mcg', 'ERGCAL', 'Vitamin D2 (ergocalciferol)', '1', 8710),
  (326, 'mcg', 'CHOCAL', 'Vitamin D3 (cholecalciferol)', '1', 8720),
  (328, 'mcg', 'VITD', 'Vitamin D (D2 + D3)', '1', 8700),
  (334, 'mcg', 'CRYPX', 'Cryptoxanthin, beta', '0', 7460),
  (337, 'mcg', 'LYCPN', 'Lycopene', '0', 7530),
  (338, 'mcg', 'LUT+ZEA', 'Lutein + zeaxanthin', '0', 7560),
  ...
  (428, 'mcg', 'MK4', 'Menaquinone-4', '1', 8950),
  (429, 'mcg', 'VITK1D', 'Dihydrophylloquinone', '1', 8900),
  (430, 'mcg', 'VITK1', 'Vitamin K (phylloquinone)', '1', 8800),
  (431, 'mcg', 'FOLAC', 'Folic acid', '0', 7000),
  (432, 'mcg', 'FOLFD', 'Folate, food', '0', 7100),
  (435, 'mcg', 'FOLDFE', 'Folate, DFE', '0', 7200),
  ...
  (573, 'mg', null, 'Vitamin E, added', '2', 7920),
  (578, 'mcg', null, 'Vitamin B-12, added', '2', 7340),
  ...
  (665, 'g', null, '18:2 t not further defined', '3', 13800),
  (666, 'g', null, '18:2 i', '3', 13700),
